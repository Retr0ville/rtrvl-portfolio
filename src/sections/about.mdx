...
> I am a self motivated Fullstack Software developer. I am a very research driven engineer and as such I have knowledge in wide range of programming environments and I can easily adjust to fill whatever role may be required of me , from centering a div on the Frontend to setting up email automations on the backend and even up to containerization with Docker and managing AWS deployments.
